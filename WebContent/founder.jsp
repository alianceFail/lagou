        ...
        <div class="content_mid">
            <dl class="c_section c_section_mid">
                ...
                <dd>
                    ...
                    <form method="post" action="addfounder" id="memberForm">
                    	<input type="hidden" value="52346c62232045a8ab1d45cb3e0540b7" name="resubmitToken">
                   	 	<input type="hidden" id="companyId" name="cid" value="${company.id}">
	                    <div id="memberDiv">
		                    <div class="formWrapper">
		                        <div class="new_portrait">
			                        ...
			                        <input type="file" value="" title="支持jpg、jpeg、gif、png格式，文件小于5M" onchange="img_check(this,'founderupload',120,120,5,'myfiles0','myfiles0_error','portraitNo0','portraitShow0','type0','leaderInfos0');" name="file" id="myfiles0" class="myfiles">
			                    	<input type="hidden" value="7" name="type" id="type0">
			                    	<input type="hidden" name="leaderInfos0photo" id="leaderInfos0">
		                            <em>
								                                尺寸：120*120px <br> 	
								                                大小：小于5M
		                            </em>
		                         ...
		                         <h3>创始人姓名</h3>
		                        <input type="text" placeholder="请输入创始人姓名" name="leaderInfos0name" id="name0" class="s_input1 valid">	
		                        
		                        <h3>当前职位</h3>
		                        <input type="text" placeholder="请输入当前职位，如：创始人兼CEO" name="leaderInfos0position" id="position0" class="s_input1 valid">	
		                        
		                        <h3>新浪微博</h3>
		                        <input type="text" placeholder="请输入创始人新浪微博地址" name="leaderInfos0weibo" id="weibo0">	
		                        
		                        <h3>创始人简介</h3> 
		                        <textarea placeholder="请输入该创始人的个人履历等，建议按照时间倒序分条展示" maxlength="1000" name="leaderInfos0remark" id="description0"></textarea>	
                    	...
                    	<a class="btn_cancel fr" href="index02.jsp">跳过</a>
                    </form>
                </dd>
            </dl>
       	</div>
