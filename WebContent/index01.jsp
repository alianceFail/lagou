    ...
    <div id="container">
        ...
        <div class="content_mid">
        	<dl class="c_section c_section_mid">
                ...
                <dd>
	                <form id="stepForm" action="addmessage" method="post">
	                	...
	                	<div class="c_text_1">基本信息为必填项，是求职者加速了解公司的窗口，认真填写吧！</div>
	                     ...
	                     <h3>公司全称</h3> <!--非必填-->
	                    <input type="text" placeholder="请输入公司全称，如:拉勾******" value="" name="holename" id="holename" >	
<%-- 							<span name="holename" id="holename">${b.holename}</span> --%>
...
<!-- 	                    	<a title="上传公司LOGO" class="inline cboxElement" href="#logoUploader"> -->
		                        ...
		                        <input type="file" value="" title="支持jpg、jpeg、gif、png格式，文件小于5M" 
			                        onchange="img_check(this,'logoupload','myfiles','logo');" 
			                        name="file" id="myfiles" class="myfiles"/>
	                    ...
	                    <h3>行业领域</h3>
	                    <div>
		                    <input type="hidden" value="" name="industry" id="select_industry_hidden">
	                    ...
	                    <div>
		                    ...
		                    <input type="button" value="请选择公司规模" id="select_scale" class="select" name="scale">
	                    ...
	                    <h3>发展阶段</h3> 
	                    <div>
		                    <input type="hidden" id="s_radio_hidden" name="radio" value="">
	                    ...
	                    <ul id="stagesList" class="reset">
	                    	<li>
	                    		<input type="hidden" class="select_invest_hidden" name="invest">
			                    ...
			                    <input type="text" placeholder="" name="org" value="">
	                    	</li>
	                    </ul>
	                    <div class="dn" id="cloneInvest">
	                    	<input type="hidden" class="select_invest_hidden" name="stage[1].invest">
		                    <input type="button" value="请选择发展阶段" class="select_short select_invest">
		                    ...
		                    <input type="text" placeholder="请输入投资机构，如真格基金，创新工场" name="stage[1].org">
	                    </div>
...
<%-- 	                    <input type="hidden" id="companyId" name="lid" value="${user.id}"> --%>
