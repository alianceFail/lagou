            ...
            <dl class="c_section c_section_mid">
                ...
                <dd>
                    ...
                    <form method="post" action="addProduct" id="productForm">
                    	...
                    	<div id="productDiv">
		                    <div class="formWrapper">
		                        ...
		                        <div class="new_product mt20">
			                        ...
			                        <input type="file" title="支持jpg、jpeg、gif、png格式，文件小于5M" onchange="img_check(this,'productupload',380,220,5,'myfiles0','myfiles0_error','productNo0','productShow0','type0','productInfos0');" 
			                        name="file" id="myfiles0">
			                    	<input type="hidden" value="3" name="productInfos0type" id="type0"> 
			                    	<input type="hidden" name="productInfos0productPicUrl" id="productInfos0">   
			                    </div>
			                   	<span style="display:none;" id="myfiles0_error" class="error"></span>
			                    
		                        <h3>产品名称</h3>
		                        <input type="text" placeholder="请输入产品名称" name="productInfos0product" id="name0">	
		                        
		                        <h3>产品地址</h3>
		                        <input type="text" placeholder="请输入产品主页URL或产品下载地址" name="productInfos0productUrl" id="address0">	
		                        
		                        <h3>产品简介</h3> 
		                        <textarea placeholder="请简短描述该产品定位、产品特色、用户群体等" maxlength="1000" name="productInfos0productProfile" id="description0"></textarea>	
                    	...
                    	<a class="btn_cancel fr" href="index03.jsp">跳过</a>
                    </form>
                </dd>
            </dl>
       	</div>
