            ...
            <div class="content_l">
            	<div class="fl" id="resume_name">
            		...
            		<form class="fl dn" id="resumeNameForm">
            			<input type="text" value="请输入您的简历标题" name="title" class="nameEdit c9" 
            			onfocus="if (value =='请输入您的简历标题'){value =''}"  onblur="if (value ==''){value ='请输入您的简历标题'}"/>	
            			<input type="hidden" value="${j.id}" name="id" id="id"  class="nameEdit c9">
            	...
            	<div class="profile_box" id="basicInfo">
            		...
            		<c:if test="${m.gender=='1'}">
            			            			<span id="basicShow"> 姓名：${m.name},性别：男<br>
            			</span>
            			</c:if>
            		<c:if test="${m.gender=='0'}">
            			            			<span id="basicShow"> 姓名：${m.name},性别：女<br>
            			</span>
            			</c:if>
            			   			<span id="basicShow">学历 ：${m.topDegree},毕业时间 ：${m.workyear}<br>
            			</span>
            			   			<span id="basicShow">电话：${m.tel},邮箱：${m.email}<br>
            			</span>
            						<span id="basicShow">当前状态：${m.currentState}<br>
            			</span>
            			<div class="m_portrait">
	                    	<div></div>
	                    	<img width="120" height="120" alt="" src="${m.photo}">
	                    </div>
            		</div><!--end .basicShow-->
            		...
            		<div class="basicEdit dn">
						  ...
						  <table>
						    <tbody><tr>
						      ...
						      <td>
						        ...
						        <input type="hidden" name="lid" id="lid" value="${j.id}">
						      </td>
						      <td valign="top"></td> 
						      <td>
						...
						<div class="new_portrait">
						  ...
						  <input type="file" value="" title="支持jpg、jpeg、gif、png格式，文件小于5M" onchange="img_check(this,'founderupload','headPic');" name="file" id="headPic" class="myfiles">
            	...
            	<div class="profile_box" id="expectJob">
            		...
            		<span>城市：${ej.expectCity}<br></span>
            		<span>工作类型：${ej.type}<br></span>
            		<span>工作 职位：${ej.expectPosition}<br></span>
            		<span>工作 收入：${ej.expectSalary}<br></span>
...
<!--              		</div>  end .expectAdd -->
            	...
            	<form class="experienceForm borderBtm dn">
            		...
            		<span>工作公司：${w.companyName}<br></span>
            		<span>工作职位：${w.positionName}<br></span>
            		<c:if test="${'至今'==w.companyYearEnd&&'至今'==w.companyMonthEnd}">
            		<span>效力时间：${w.companyYearStart}年${w.companyMonthStart}月---至今<br></span>
            		</c:if>
            		<c:if test="${'至今'!=w.companyYearEnd&&'至今'!=w.companyMonthEnd}">
            		<span>效力时间：${w.companyYearStart}年${w.companyMonthStart}月---${w.companyYearEnd}年${w.companyMonthEnd}月<br></span>
					</c:if>
...
<!--             		</div>end .experienceAdd -->
            	...
            	<div class="profile_box" id="projectExperience">
            		...
            		<span>项目名称：${pe.projectName}<br></span>
            		<span>项目职位：${pe.thePost}<br></span>
            		<c:if test="${'至今'==pe.projectYearEnd&&'至今'==pe.projectMonthEnd}">
            		<span>效力时间：${pe.projectYearStart}年${pe.projectMonthStart}月---至今<br></span>
            		</c:if>
            		<c:if test="${'至今'!=pe.projectYearEnd&&'至今'!=pe.projectMonthEnd}">
            		<span>效力时间：${pe.projectYearStart}年${pe.projectMonthStart}月---${pe.projectYearEnd}年${pe.projectMonthEnd}月<br></span>
					</c:if>
            		<span>项目描述：${pe.projectDescription}<br></span>
...
<!--             		</div>end .projectAdd -->
            	...
            	<div class="profile_box" id="educationalBackground">
            		...
            		<span>学校名称：${eg.schoolName}<br></span>
            		<span>毕业学历：${eg.degree}<br></span>
            		<span>专业名称：${eg.professionalName}<br></span>
            		<span>在校时间：${eg.schoolYearStart}年-${eg.schoolYearEnd}年<br></span>
...
<!--             		</div>end .descriptionAdd -->
            	...
            	<div class="profile_box" id="worksShow">
            		...
            		<span>作品链接：<a href="http://${ws.worklink}">${ws.worklink}</a><br></span>
            		<span>作品展示：${ws.workshow}</span>
            ...
            <div class="content_r">
				...
				<div class="mycenterR" id="myResume">
            		...
            		<div class="resumeUploadDiv" >
	            			            		<span id="message12138">我的附件简历：${j.jianli}</span><span id="mes2" style="display: none"></span>
	            		            		</div>
            	</div><!--end #myResume-->
	        	...
	        	<td align="center">
	                <form>
	                    <a class="btn_addPic" href="javascript:void(0);">
	                    	<span>选择上传文件</span>
	                    	<input type="hidden" name="lid" id="lid" value="${j.id}"/>
	                        <input type="file" onchange="file_check(this,'jianliupload','resumeUpload')" class="filePrew" id="resumeUpload" name="file" size="3" title="支持word、pdf、ppt、txt、wps格式文件，大小不超过10M" tabindex="3">
	                    </a>
	                </form>
	            </td>
	        </tr>
