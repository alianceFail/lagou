            	            ...
            	            <ul class="hot_pos reset">
            	            	<c:forEach var="list" items="${list}">
	                    		                    			                <li class="odd clearfix">
			                			                				                	<div class="hot_pos_l">
			                        <div class="mb10">
			                            <a href="h/jobs/86989.html" title="${list.positionName}" target="_blank">${list.positionName}</a> 
			                            &nbsp;
			                            <span class="c9">${list.workAddress }</span>
			                            			                        </div>
			                        <span><em class="c7">月薪：</em>${list.salaryMin}k-${list.salaryMax}k</span>
			                        <span><em class="c7">经验：</em>${list.workYear}</span>
			                        <span><em class="c7">最低学历： </em>${list.education}</span>
			                        <br />
			                        <span><em class="c7">职位诱惑：</em>${list.positionAdvantage}</span>
			                        <br />
			                        <span>${list.positionDetail}</span>
			                    </div> 
						        <div class="hot_pos_r">
			                        <div class="apply">
			                        <a href="selectjob?id=${list.id}" target="_blank">投个简历</a>
			                        				                        </div>
			                        <div class="mb10"><a href="h/c/1712.html" title="紫色医疗" target="_blank">${list.c.c.holename}</a></div>
			                        <span><em class="c7">领域： </em>${list.c.c.industry}</span>
			                        			                        <span><em class="c7">创始人：</em> ${list.c.f.name} </span>
			                        			                        <br />
			                        <span><em class="c7">阶段： </em>${list.c.c.radio}</span>
			                        <span><em class="c7">规模： </em>${list.c.c.scale}</span>
			                        <ul class="companyTags reset">
			                            			                            				                            		<li>${list.c.l.labels}</li>
