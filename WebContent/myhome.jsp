	                ...
	                <div class="c_detail">
	                	<div style="background-color:#fff;" class="c_logo">
		                	<a title="上传公司LOGO" id="logoShow" class="inline cboxElement" href="#logoUploader">
		                				                			<img width="190" height="190" alt="公司logo" src="${cm.logo}">
	                    ...
	                    <div class="c_box companyName">
	                    		                   			<h2 title="公司名称">${cm.holename}</h2>
	                   			                        	<input type="hidden" name="id" value="${cm.holename}" />
	                        	...
	                        	<a target="_blank" class="applyC" href="http://www.lagou.com/c/auth.html">申请认证</a>
	                        	                        <div class="clear"></div>
	                       		                   			...
	                       		                   			<h1 title="公司简称" class="fullname">${cm.name}</h1>
	                        	                        
	                        <form class="clear editDetail dn" id="editDetailForm">
	                            <input type="text" placeholder="请输入公司简称" maxlength="15" value="abababab" name="companyShortName" id="companyShortName">
	                            <input type="text" placeholder="一句话描述公司优势，核心价值，限50字" maxlength="50" value="qweqweqwe" name="companyFeatures" id="companyFeatures">
	                            <input type="hidden" value="${c.id}" id="companyId" name="companyId">
	        					...
	        					<div class="product_wrap">
					                ...
					                <dl id="newProduct" class="newProduct dn">
					                    ...
					                    <dd>
					                        <form method="post" class="productForm">
					                            ...
					                            <div class="cp_intro">
					                               	<input type="text" placeholder="请输入产品名称" value="请输入产品名称" name="product">	
					                                <input type="text" placeholder="请输入产品网址" value="请输入产品网址" name="producturl">	
					                                <textarea placeholder="请简短描述该产品定位、产品特色、用户群体等" maxlength="500" value="请简短描述该产品定位、产品特色、用户群体等" class="s_textarea" name="productprofile">${p.productprofile}</textarea>	
					                ...
					                <dl class="c_product">
					                    ...
					                    <c:forEach items="${plist}" var="p">
					                    	<img width="380" height="220" alt="发大发" src="${p.productphoto}">
				                        	<div class="cp_intro">
				                        						                        		<h3><a target="_blank" href="${p.producturl}">${p.product} </a></h3>
					                            <div class="scroll-pane" style="overflow: hidden; padding: 0px; width: 260px;">
					                            	
					                            <div class="jspContainer" style="width: 260px; height: 140px;"><div class="jspPane" style="padding: 0px; top: 0px; width: 260px;"><div>${p.productprofile}</div></div></div></div>
					                        </div>
					                        </c:forEach>
       				...
       				<div id="Profile">
					            ...
					            <!--有介绍-->
					               <dl class="c_section">
					                   	...
					                   	<dd>
					                   		<div class="c_intro" >${c.companyProfile}</div>
						...
						<dl id="noJobs" class="c_section">
		                    ...
		                    <dd>
		                    	...
		                    	<c:forEach items="${jlist}" var="j">
		                        	<span>职位名称：${j.positionName}---${j.jobNature}<br></span>
		                        	<span>职位信息：${j.positionType}---${j.department}<br></span>
		                        	<span>工作地点：${j.workAddress},月薪:${j.salaryMin}K--${j.salaryMax}K<br></span>
		                        	</c:forEach>
	            	...
	            	<div id="c_tags_show" class="c_tags solveWrap">
	                    <table>
	                        ...
	                        <tr>
	                            <td>主页</td>
	                            <td>
	                            	            							<a rel="nofollow" title="http://www.weimob.com" target="_blank" href="http://www.weimob.com">${cm.website}</a>
            							                            </td>
	                        </tr>
	                    </tbody></table>
       			...
       			<dl class="c_section c_stages">
                    ...
                    <dd>
                    	<ul class="reset stageshow">
                    		<li>目前阶段：<span class="c5">${cm.radio}</span></li>
                    		                    	</ul>
			       					...
			       					<div class="member_wrap">
				                    	...
				                    	<div class="member_info">
				                        	...
				                        	<div class="m_portrait">
				                            	<div></div>
				                            	<img width="120" height="120" alt="孙泰英" src="${f.founderphoto}">
					                        </div>
				                            <div class="m_name">
				                            	${f.name}
			                            		                            						<a target="_blank" class="weibo" href="${f.weibo}"></a>
				                            					                            </div>
				                            <div class="m_position">${f.position}</div>
				                    		<div class="m_intro">${f.remark}</div>
				                        </div>
				                        </c:forEach>
				                     </div><!-- end .member_wrap -->
				                     				                 		                    </dd>
		                	...
		                	<!-- 编辑报道 -->
                       		<ul class="reset"><li>
                       			<c:forEach items="${rlist}" var="r">
		                			<a style="" class="article" title="随便写" target="_blank" href="http://${r.articleUrl}">${r.articleTitle}</a>
		                			</c:forEach>
		                			...
		                			<form class="reportForm dn" >
			                            ...
			                            <input type="hidden" value="${c.id}" class="article_id" name="cid">
			                     	</form>
		                		</li><li>
		                			...
		                			<form class="reportForm dn">
		                				...
		                				<input type="submit" value="保存" class="btn_small">
			                            <a class="btn_cancel_s report_delete" href="javascript:;">删除</a>
			                            <input type="hidden" value="${c.id}" class="article_id">
			                     	</form>
		                		</li></ul>
...
<%-- 		                				<input type="hidden" value="${login.id}" name="lid"/> --%>
		                				<input type="submit" value="保存" class="btn_small">
