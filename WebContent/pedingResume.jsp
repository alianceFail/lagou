...
<div id="body">
	<div id="header">
       ...
       <div id="container">
		...
		<dt>我收到的简历</dt>
		<dd class='current'>
		<a href="pedingResume.jsp">待处理简历</a> 
			</dd>
	<dd>
  					...
  					<c:forEach items="${tlist}" var="t">
		                <li data-id="1686182" class="onlineResume">
			                              ...
			                              <a title="预览在线简历" target="_blank" class="resumeImg" href="resumeView.html?deliverId=1686182">
			                                        ...
			                                        <h3 class="unread">
														<a target="_blank" title="预览${jianli.title}的简历" href="resumeView.html?deliverId=1686182">
			                                        			${jianli.title}的简历
			                                        	</a>
			                                        					                           	 			<em></em>
			                                        </h3> 
			                                        <span class="fr">投递时间：<fmt:formatDate value="${t.date}" pattern="yyyy-MM-dd"/></span>
			                                        <c:if test="${m.gender=='1'}">
			                                        <div> 
			                                        	${m.name}  			                                        	 / 男 			                                        	/ 大专 			                                        	/ 3年  			                                        	/ 广州 			                                            			                                        		<br>
			                                            	${work.positionName} · ${work.name} | ${education.degree} · ${education.schoolName}
			                                        </div>
			                                        </c:if>
			                                        <c:if test="${m.gender=='0'}">
			                                        <div> 
			                                        	${m.name}  			                                        	 /  女			                                        	/ 大专 			                                        	/ 3年  			                                        	/ 广州 			                                            			                                        		<br>
			                                            	${work.positionName} · ${work.companyName} | ${education.degree} · ${education.schoolName}
			                                        </div>
			                                        </c:if>
			                                        <div class="jdpublisher">
				                                        <span>
				                                        	应聘职位：<a title="随便写" target="_blank" href="http://www.lagou.com/jobs/149594.html">${job.positionName}</a>
				                                       						                                        <br></span>
			                                        </div>
			                                    </div>
			                                    <div class="links">
			                                        <a data-deliverid="1686182" data-name="jason" data-positionid="149594" data-email="888888888@qq.com" class="resume_notice" href="javascript:void(0)">待定</a>
			                                ...
			                                <div class="contactInfo">
			                                	<span class="c9">电话：</span>${message.tel}   &nbsp;&nbsp;&nbsp;   
			                                    <span class="c9">邮箱：</span><a href="mailto:888888888@qq.com">${message.email}</a>
			                                </div>
			                            </li>
			                            </c:forEach>
		                            		                    	</ul><!-- end .resumeLists -->
