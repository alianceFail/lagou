...
<!--         	<img src="style/images/psw_step1.png" width="369" height="56" alt="找回密码第一步" /> -->
        	...
        	<div><strong style="size: 60px;color: green;">第二步：</strong>修改密码</div><br>
        	
            <form id="pswForm" action="rePass01" method="post">
           		<input type="password" name="pass" id="pass" tabindex="1" value="" placeholder="请输入新密码" />
           		<span class="error" style="display:none;" id="beError"></span>
           		<input type="password" name="surePass" id="surePass" tabindex="1" value="" placeholder="请再次输入密码" />
...
<script type="text/javascript">
    $(document).ready(function() {
    	...
    	$('#surePass').blur(function(){
    		...
    		if(pass != surePass && pass !="请输入新密码" )
    			{
    				$('#beError').text("两次密码不相同！！").show();
    				$('#submitLogin').attr("disabled", true);
    			}else
    				{
