...
function img_check(a, b, c) {
    ...
    $.ajaxFileUpload({
        ...
        success: function(a) {
            if (a.success) {
                var b = a.img;
                $("#portraitShow img").attr("src", d+b),
                $("#basicInfo .basicShow img").attr("src",  d+b),
                $("#portraitNo").hide(),
                $("#portraitShow").show()
            } else errorTips("上传失败，请重新上传", "上传头像")
        },
...
function file_check(obj, action_url, id) {
    ...
    0 != this.AllowExt && -1 == this.AllowExt.indexOf(this.FileExt) ? (errorTips("只支持word、pdf、ppt、txt、wps格式文件，请重新上传"), $("#loadingImg").css("visibility", "hidden")) : 
    	$.ajaxFileUpload({
    		type: "POST",
    		url: action_url,
    		secureuri: true,
...
//            	alert($("#mes2").val(m));
           ...
           /* $("#loadingImg").css("visibility", "hidden"),
            b.success ? (html = '<a href="'  + '/jianliupload" class="resume_download" title="下载' + b.file + '">' + b.file + "</a>" + '<a  class="fr del" href="javascript:;">删除</a><br /><span class="c9">上传时间：' + json.content.time + "</span>", $("#myResume .resumeUploadDiv").html(html), 
...
//                        $(a).find(":submit").val("保 存").attr("disabled", !1)
                        e="项目名字："+b.projectName+"||担任职务："+b.thePost+"||开始时间："+b.projectYearStart+"年"+b.projectMonthStart+"月"+"||结束时间："+b.projectYearEnd+"年"+b.projectMonthEnd+"月";
                        if( $("#resubmitToken").val(b.resubmitToken),b.success )
                        {
                        //$("#resubmitToken").val(b.resubmitToken),
                        //b.success ? (c = b.content.projectExperience, e = "", 3 == b.code ? "" != c ? (e += '<li data-id="' + c.id + '">', e += '<div class="projectList"><i class="sm_del dn"></i><i class="sm_edit dn"></i><div class="f16 mb10" data-proName="' + c.projectName + '" data-posName="' + c.positionName + '" data-startY="' + c.startYear + '" data-startM="' + c.startMonth + '" data-endY="' + c.endYear + '"' + 'data-endM="' + c.endMonth + '">' + c.projectNameAndRemark + '<span class="c9">（' + c.startDate + "-" + c.endDate + "）</span></div>", "" != c.projectRemark && (e += '<div class="dl1">' + c.projectRemark + "</div>"), e += "</div></li>", 
                        		//alert(e);
                        	    d.obj.children(".projectShow").children(".plist").html() && $(a).remove(), 
                        		...
                        		d.obj.children(".projectShow").children(".plist").html() ? 
                        	   ($(a).remove(), 
                        		d.obj.children(".c_add").removeClass("dn")) 
                        		:(
                        		d.obj.children(".projectEdit").addClass("dn"), 
                        		...
                        		//4 == b.code ? (e += '<div class="projectList"><i class="sm_del dn"></i><i class="sm_edit dn"></i><div class="f16 mb10" data-proName="' + c.projectName + '" data-posName="' + c.positionName + '" data-startY="' + c.startYear + '" data-startM="' + c.startMonth + '" data-endY="' + c.endYear + '"' + 'data-endM="' + c.endMonth + '">' + c.projectNameAndRemark + '<span class="c9">（' + c.startDate + "-" + c.endDate + "）</span></div>", 
                        		//"" != c.projectRemark && (e += '<div class="dl1">' + c.projectRemark + "</div>"), e += "</div>", $(a).parent("li").html(e)) : 2 == b.code && ($(a).parent("li").remove(),
								d.obj.children(".projectShow").children(".plist").children("li").length && d.AddCancel
								), 
...
//                        												e.url && (d = "http://" == e.url.substring(0, 7) || "https://" == e.url.substring(0, 8) ? e.url: "http://" + e.url, c += '<div class="f16">网址：<a href="' + d + '" target="_blank">' + e.url + "</a></div>"), c += "<p>" + e.workName + "</p>" + "</div>", placeholderFn(),
//                        												$(a).parent("li").html(c)) : 2 == b.code && ($(a).parent("li").remove(), "" == $.trim(h.obj.children(".workShow").children(".slist").html()) && h.AddCancel), 
...
//                        $(a).find(":submit").val("保 存").attr("disabled", !1)
                        ...
                        if( $("#resubmitToken").val(b.resubmitToken),b.success )
                        {
                        	e="作品链接："+b.link+"作品描述："+b.msg;
                        	alert(e);
                        	"" != $.trim(h.obj.children(".workShow").children(".slist").html()) && $(a).remove(), 
    						h.obj.children(".workShow").children(".slist").prepend(e),
    						h.obj.children(".workShow").removeClass("dn"),
    						h.obj.children(".workEdit").addClass("dn"),
    						h.obj.children(".c_add").removeClass("dn"), 
    						h.obj.children(".workShow").children(".slist").html() ? ($(a).remove(),
                        	//b.link && (d = "http://" == b.link.substring(0, 7) || "https://" == b.link.substring(0, 8) ? b.link: "http://" + b.link, c += '<div class="f16">网址：<a href="' + d + '" target="_blank">' + b.link + "</a></div>"), c += "<p>" + b.msg + "</p>" + "</div>", placeholderFn(),
							$(a).parent("li").html(c)) : 2 == b.code && ($(a).parent("li").remove(),
							"" == $.trim(h.obj.children(".workShow").children(".slist").html()) && h.AddCancel), 
							h.obj.find(".slist li:last-child").addClass("noborder"), 
							$("#lastChangedTime span").text(str),
							$("#resumeScore .which div").text(b.content.infoCompleteStatus.msg),
							$("#resumeScore .which span").attr("rel", b), 
							scoreChange(b.content.infoCompleteStatus.score),
							k(h.obj)
                        }else alert("失败！！"+b.msg);
                        $(a).find(":submit").val("保 存").attr("disabled", !1)
        ...
        submitHandler: function(a) {
            ...
            dataType: "json"
                ...
                if (b.success) {
                    ...
                    str+=(newdate.getMinutes());
//                    var c = "";
//                    c = e.length > 18 ? e.substring(0, 15) + "...": e,
                    e.length > 18 ? e.substring(0, 15) + "...": e,
                    $("#resume_name .nameShow h1").attr("title", e).text(e+"的简历").parent().removeClass("dn"),
...
//                	c = b.content.resume, d = c.workYear, "应届毕业生" != d ? 
//        					(d += "工作经验", $("#workExperience h2 span").text("（投递简历时必填）")) : 
//        						$("#workExperience h2 span").text(""), e = c.name,
//        						"" != c.sex && (e += " | " + c.sex),
//        						"" != c.highestEducation && (e += " | " + c.highestEducation),
        						//e += " | " + d + "<br />" + c.phone + " | " + c.email + "<br />" + c.status, 
        						$(".collapsible_menu dt").html(b.name + "<i></i>"), 
        						$("#basicInfo .basicShow span").html(b).parent().removeClass("dn"), 
        						$("#basicInfo .basicEdit").addClass("dn"), 
        						$("#basicInfo .c_edit").removeClass("dn"), 
        						$("#nameVal").val(b.name), 
        						$("#genderVal").val(b.gender), 
        						$("#topDegreeVal").val(b.topDegree), 
        						$("#workyearVal").val(b.workyear), 
        						$("#currentStateVal").val(b.currentState), 
        						$("#emailVal").val(b.email), 
        						$("#telVal").val(b.tel), 
        						$("#basicShow").text(b.name+"||"+sex+"||"+b.topDegree+"||"+b.workyear+"||"+b.email+"||"+b.tel+"||"+b.currentState);
        						//$("#lastChangedTime span").text(b.content.refreshTime), 
        						//b.content.isNew && changeAllIds(b.content.jsonIds), 
        						//scoreChange(b.content.infoCompleteStatus.score), 
        						k($("#basicInfo")),
...
//                  if (g!=null) {
//                      if (c || d || e || f) {
//                          var h = g.job+"|"+g.city+"|"+g.salary;
////                          获取时间
//                          var _date = g.fixdate.time; 
...
//                          b.obj.find("#expectJobVal").val(g.job),
//                          b.obj.find("#expectCityVal").val(g.city),
//                          b.obj.find("#typeVal").val(g.type),
//                          b.obj.find("#expectPositionVal").val(g.job),
//                          b.obj.find("#expectSalaryVal").val(g.salary),
//                          b.expectJobVal = g.job,
//                          b.expectCityVal = g.city,
//                          b.typeVal = g.type,
//                          b.expectPositionVal = g.job,
//                          b.expectSalaryVal = g.salary,
//                          
  //
//                          
//                          $("#lastChangedTime span").text(str),
//                          //$("#resumeScore .which div").text(g.job),
//                          $("#resumeScore .which span").attr("rel", g.salary),
//                          scoreChange(g.score),
//                          k(b.obj)
...
//      }),
              	...
              	if (g.success) {
                      if (c || d || e || f) {
                          var h ="城市："+g.expectCity+"|类型："+g.type+"|工作："+g.expectPosition+"|\n\n工资："+g.expectSalary;
                          ...
                          b.obj.find(".c_edit").removeClass("dn"),
                          b.obj.find(".expectEdit").addClass("dn"),
                          b.obj.find("#expectJobVal").val(g.expectPosition),
                          b.obj.find("#expectCityVal").val(g.expectCity),
                          b.obj.find("#typeVal").val(g.type),
                          b.obj.find("#expectPositionVal").val(g.expectPosition),
                          b.obj.find("#expectSalaryVal").val(g.expectSalary),
                          b.expectJobVal = g.expectPosition,
                          b.expectCityVal = g.expectCity,
                          b.typeVal = g.type,
                          b.expectPositionVal = g.expectPosition,
                          b.expectSalaryVal = g.expectSalary,
                          
                          
                          alert($("#lastChangedTime span").text(str)),
                          //alert($("#resumeScore .which div").text(str)),
                          alert($("#resumeScore .which span").attr("rel", g.expectSalary));
                          
                          //scoreChange(g.content.infoCompleteStatus.score),
                          //k(b.obj)
                         } else 
                      	//$("#news").text("城市："+g.expectCity+"类型："+g.type+""+"")
                 		    //$("#news").append("\n\n\n"+"\n"+"工作："+g.expectPosition+"\n\n工资："+g.expectSalary)	
        ...
        $(this).validate({
            ...
            submitHandler: function(a) {
                ...
                $.ajax({
                    ...
                    str+=(newdate.getMinutes());
                    //if(b.success){
                    //$("#news123").text("公司："+b.companyName+ "||"+"||职位："+b.positionName+"||工作开始时间："+b.companyYearStart+"||"+"工作结束时间："+b.companyYearEnd)
                   if (b.success) {
                	   ...
                	   e="公司："+b.companyName+ "||"+"||职位："+b.positionName+"||工作开始时间："+b.companyYearStart+"||"+"工作结束时间："+b.companyYearEnd;
                	   //$("#news").text("城市："+g.expectCity+"类型："+g.type+""+"")
                        ...
                        $("#lastChangedTime span").text(str),
                        //$("#resumeScore .which div").text(b),
                        $("#resumeScore .which span").attr("rel", b.companyName)
                       // scoreChange(b.content.infoCompleteStatus.score),
                        k(c.obj),
                       // b.content.isNew && changeAllIds(b.content.jsonIds)
                        alert(b);
...
//    }), 
                    ...
                    if (b.success) {
                        ...
                        //for (c = b.content.educationExperiences, d = "", e = 0; e < c.length; e++) d += 0 == e % 2 ? '<li data-id="' + c[e].id + '" class="clear">': '<li data-id="' + c[e].id + '">',
                        //d += '<i class="sm_del dn"></i><i class="sm_edit dn"></i><span class="c9" data-startY="' + c[e].startDate + '" data-endY="' + c[e].endDate + '">' + c[e].startDate + "-" + c[e].endDate + "</span>" + "<div>" + '<h3 data-schName="' + c[e].schoolName + '">' + c[e].schoolName + "</h3>" + '<h4 data-proName="' + c[e].professional + '" data-degree="' + c[e].education + '">' + c[e].education + "，" + c[e].professional + "</h4>" + "</div>" + "</li>";
                        //h="学校："+b.schoolName+"||学历："+b.degree+"||专业："+b.professionalName+"||入学年份："+b.schoolYearStart+"||毕业年份"+schoolYearEnd;
                        d="学校："+b.schoolName+"||学历："+b.degree+"||专业："+b.professionalName+"||入学年份："+b.schoolYearStart+"||毕业年份: "+b.schoolYearEnd;
                    	alert(b.schoolYearEnd);
                        f.obj.children(".c_add").removeClass("dn"),
                        f.obj.children(".educationalShow").children(".educationalForm").hide(),
                        f.obj.children(".educationalShow").children(".elist").html(d).parent().removeClass("dn"),
                        f.obj.children(".educationalEdit").addClass("dn"),
                       ...
                       // b.content.isNew && changeAllIds(b.content.jsonIds)
//                    if(b.success){
//                		$("#educationnews").text("学校："+b.schoolName+"||学历："+b.degree+""+"")
//                		$("#educationnews").append("\n\n\n"+"\n"+"专业："+b.professionalName+"\n\n入学年份："+b.schoolYearStart+"\n\n\n"+"毕业年份"+schoolYearEnd)
                    } else alert(b.msg);
                    $(a).find(":submit").val("保 存").attr("disabled", !1)
                })
            }
...
//                				$("#resumeScore .which span").attr("rel", b.content.infoCompleteStatus.nextStage), 
//                				scoreChange(b.content.infoCompleteStatus.score),
//                				k(g.obj)) : (g.text = "", g.obj.children(".c_edit").addClass("dn"), 
...
//                $(a).find(":submit").val("保 存").attr("disabled", !1)
                if( $("#resubmitToken").val(b.resubmitToken),b.success )
                {
                	...
                	alert(e);
    				g.obj.children(".c_edit").removeClass("dn"),
    				g.obj.children(".descriptionShow").html(e).removeClass("dn"),
    				g.obj.children(".descriptionEdit").addClass("dn"), 
    				$("#lastChangedTime span").text(str), 
//    				$("#resumeScore .which div").text(b.content.infoCompleteStatus.msg), 
    				$("#resumeScore .which span").attr("rel", b), 
