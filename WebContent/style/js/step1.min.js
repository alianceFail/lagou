...
//            "" != a ? ($("#logoShow img").attr("src", m+b), 
//            $("#logoNo").hide(), $("#logoShow").show(), $("#logo").val(b)) : $("#" + c + "_error").text("上传失败，请重新上传").show()
        },
        error: function() {
            $("#" + c + "_error").text("上传失败，请重新上传").show()
        }
...
$(function() {
    ...
    function(a) {
        ...
        $(this).hasClass("current") ? ($(this).removeClass("current"), $("#box_industry li.current").each(function() {
            ...
            b.push($(this).text())
        }), $("#select_industry").val(b.join()), $("#select_industry_hidden").val(b.join()), $("#box_industry").hide()) : $(this).siblings("li.current").length >= 2 && alert("行业领域最多可选2个"),
    ...
    $("#stepForm").validate({
        ...
        messages: {
            ...
            website: {
                required: "请输入公司网址，如：324324www.lagou.com",
                checkUrl: "treter请输入有效的公司网址",
                maxlength: "请输入120字符以内的网址"
            },
            city: {
                required: "请输入公司所在城市，如：113北京",
                maxlenStr: "gdgdd请输入有fdsfdsf效的公司所在城市"
            },
            select_industry_hidden: {
                required: "请选择公司行业领域"
            },
