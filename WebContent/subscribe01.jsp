        ...
        <div class="clearfix">
            <div class="content_l">
            	...
            	<c:forEach items="${joblist}" var="j">
	                    ...
	                    <input type="hidden" id="pn1" value="${j.positionName}">
	                    <input type="hidden" id="ci1" value="${j.city}">
	                    <input type="hidden" id="inf1" value="${j.industryField}">
	                    <input type="hidden" id="fs1" value="${j.financeStage}">
	                    <input type="hidden" id="sa1" value="${j.salary}">
	                    <input type="hidden" id="smp1" value="${j.sendMailPer}">
	                    <input type="hidden" id="em1" value="${j.email}">
	                </div>
	                </c:forEach>
