...
<div style="display:none;">
	...
	<div style="height:280px;" class="popup" id="setResume">
	    <table width="100%">
	    	...
	    	<tr>
	        	<td>
                    <form class="resumeSetForm" id="resumeSetForm" action="addtoudi" method="post">
	            		<label class="radio">
	            			<input type="radio" value="1" class="resume1" name="resumeName">
	            			在线简历：
	            				            				<span title="jason的简历">${jian.title}的简历</span>
	            				            		</label>
            			<div class="setBtns">
	        	...
	        	<td>
                    <form class="resumeSetForm" id="resumeSendForm">
	            		<label class="radio">
	            			...
	            			在线简历：
	            				            				<span title="jason的简历">${jian.title}的简历</span>
	            				            				<input type="hidden" name="jid" id="jid" value="${jian.id}">
	            				            				<input type="hidden" name="bid" id="bid" value="${j.id}">
	            				            		</label>
            			<div class="setBtns">
